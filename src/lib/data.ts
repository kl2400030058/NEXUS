...
const sessions: Session[] = [
  ...
  },
  {
    ...
    description: 'Elevate your design skills with this deep-dive into advanced UI/UX principles and practices.',
    longDescription: 'This workshop is for designers and developers looking to master advanced UI/UX concepts. We will cover motion design, micro-interactions, advanced prototyping with Figma, and conducting effective user testing. Participants will work on a real-world project to apply these concepts and receive expert feedback.',
    speakerId: 'speaker-2',
    date: '2024-09-10',
  ...
  },
  {
    ...
    description: 'An introduction to the Go programming language, covering syntax, concurrency, and building simple web services.',
    longDescription: 'Curious about Go? This workshop is the perfect starting point. We\'ll introduce you to Go\'s syntax, powerful standard library, and its famous concurrency model using goroutines and channels. You\'ll leave having built and tested a simple, high-performance web service. No prior Go experience is necessary, but some programming knowledge is assumed.',
    speakerId: 'speaker-3',
    date: '2024-09-12',
  ...
  },
  {
    ...
    description: 'Learn to build your first native Android application using Kotlin, the official language for Android.',
    longDescription: 'This workshop provides a comprehensive introduction to building native Android apps. We will cover setting up your development environment with Android Studio, understanding the fundamentals of Kotlin, building user interfaces with Jetpack Compose, and handling user input. You will build a complete, simple application from start to finish.',
    speakerId: 'speaker-4',
    date: '2024-09-15',
  ...
  },
  {
    ...
    description: 'A hands-on workshop on creating beautiful, interactive data visualizations for the web with D3.js.',
    longDescription: 'Turn data into compelling stories with D3.js. This workshop will teach you the fundamentals of D3, including data binding, selections, and scales. You will learn to create various chart types, from simple bar charts to more complex, interactive visualizations. Strong JavaScript knowledge is required for this session.',
    speakerId: 'speaker-1',
    date: '2024-09-20',
  ...
  },
  {
    ...
    description: 'A fast-paced coding competition where speed and accuracy are key. Solve as many problems as you can in 3 hours.',
    longDescription: 'The Code Sprint Challenge is all about speed. You will be presented with a set of 10-15 programming puzzles. The goal is to solve as many as possible within the 3-hour time limit. The faster you solve, the higher your score. This contest is language-agnostic, so you can use your programming language of choice.',
    speakerId: 'speaker-5',
    date: '2024-09-21',
  ...
  },
  {
    id: 'session-21',
    title: 'The Bug Bash',
    description: 'A unique contest where developers compete to find and report the most bugs in a set of sample applications.',
    longDescription: 'It\'s time to put on your QA hat. In The Bug Bash, contestants will get access to several applications with known (and unknown) bugs. Your job is to find, document, and report as many bugs as possible. Points are awarded based on the severity and quality of your bug reports. The developer with the most points at the end wins.',
    speakerId: 'speaker-3',
    date: '2024-10-01',
    time: 'All Day',
    venue: 'Online',
  ...
  },
  {
    ...
    description: 'A data science competition where participants build machine learning models to solve a real-world problem.',
    longDescription: 'The Data Science Derby is a machine learning competition where you\'ll be given a dataset and a problem to solve. Whether it\'s a classification, regression, or clustering problem, you\'ll need to build, train, and evaluate a model to achieve the best performance. This is a great way to apply your data science skills.',
    speakerId: 'speaker-1',
    date: '2024-10-10',
    time: '48 Hours',
    venue: 'Virtual Event',
  ...
  },
  {
    ...
    description: 'A design contest where participants create high-fidelity mockups for a new mobile or web application.',
    longDescription: 'Calling all designers! In the UI/UX Design-a-thon, you\'ll be given a creative brief for a new application. Your task is to design a beautiful, intuitive, and user-friendly interface. Submissions will be judged based on creativity, usability, and visual polish. You can use any design tool you like (Figma, Sketch, Adobe XD, etc.).',
    speakerId: 'speaker-2',
    date: '2024-10-18',
    time: '24 Hours',
    venue: 'Virtual',
  ...
  {
    id: 'session-24',
    title: 'Cloud Architect Challenge',
    description: 'Design and document a scalable and resilient cloud architecture for a given scenario.',
    longDescription: 'This is not a coding contest, but an architecture design challenge. Participants will be given a complex business problem and will need to design a complete cloud architecture on Google Cloud to solve it. Your submission should include architecture diagrams, service choices, and a justification for your design. The most robust and cost-effective design wins.',
    speakerId: 'speaker-3',
    date: '2024-11-01',
    time: '72 Hours',
    venue: 'Online',
